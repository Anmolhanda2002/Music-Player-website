...
?>
	<div id="page-wrapper">
		<div class="inner-content">	<div class="music-left">
					<!--banner-section-->
			...
			<!--//pop-up-box -->
				<div class="albums">
						<div class="tittle-head">
							...
							<a href="index11.php"><h4 class="tittle">See all</h4></a>
							<div class="clearfix"> </div>
						</div>
						<?php     
        ...
        ?>
			...
			<!--//End-albums-->
				...
				<div class="albums second">
								<div class="tittle-head">
									<h3 class="tittle">Discover Artist <span class="new">View</span></h3>
							...
							<div class="video-record-list">
								<div id="jp_container_1" class="jp-video jp-video-270p" role="application" aria-label="media player">
									<div class="jp-type-playlist">
										<div id="jquery_jplayer_1" class="jp-jplayer" style="width: 480px; height: 320px;"><img id="jp_poster_0" src="video/play1.png" style="width: 480px; height:320px; display: inline;"><video id="jp_video_0" preload="metadata" src="http://192.168.30.9/vijayaa/2015/Dec/mosaic/web/video/Ellie-Goulding.webm" title="1. Ellie-Goulding" style="width: 0px; height: 0px;"></video></div>
										<div class="jp-gui">
