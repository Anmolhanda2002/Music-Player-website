...
if(isset($_REQUEST["submit"]))
{
    ...
    //insert query
    $query = "update `artists` set `artist_name`='$artist_name', `thumbnail`='$new_name' where `id`='$id'";
    ...
    if($result>0)
    {
        ...
        echo "<script>window.location.assign('manage_artists.php?msg=Record Updated')</script>";
    }
    else{
